...
SECRET_KEY = 'django-insecure-i-6q_v8@3ky1r^dcy1sncam(7r69#+u)@a17mo5vtnqt2msa*l'
...
# CORS Settings
# Allow requests from your frontend origin (replace 3000 if you used a different port)
...
# Alternatively, for development/testing, you can allow all origins (less secure for production)
